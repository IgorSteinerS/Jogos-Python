...
class SnakeGame:
    ...
    def initialize_surfaces(self):
        ...
        self.snake_surface = pygame.image.load('imgs/snakeBodyPart.png').convert_alpha()
        self.snake_surface = pygame.transform.scale(self.snake_surface, (20, 20))
        self.snake_rect = self.snake_surface.get_rect(topleft=(300, 300))

        # Load and scale apple image
        self.apple_surface = pygame.image.load('imgs/AppleSquare.png').convert_alpha()
        self.apple_surface = pygame.transform.scale(self.apple_surface, (20, 20))
    ...
    def update_game_state(self):
        ...
        if self.game_active:
            ...
            for body_part in self.snake_body:
                self.screen.blit(self.snake_surface, pygame.Rect(body_part, (20, 20)))
            self.screen.blit(self.apple_surface, self.apple_rect)
